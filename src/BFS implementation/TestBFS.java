...
public class TestBFS {
    public static void main(String[] args) {
        String[] vertices = {"Seattle", "San Francisco", "Los Angeles",
         ...
         AbstractGraph<String>.Tree bfs = graph.bfs(graph.getIndex("Boston"));
         List<Integer> searchOrders = bfs.getSearchOrder();

         System.out.println(bfs.getNumberOfVerticesFound() + " vertices are searched in the following order: ");
